    ...
    <div className={`transition-all ${navbg?'bg-white shadow-md':'fixed'} duration-200 h-[12vh] z-[100] fixed w-full`}>
      <div className='flex items-center h-full justify-between w-[90%] xl-:w-[80%] mx-auto'>
        ...
        <div className='flex items-center space-x-2'>
            ...
            <h1 className="text-xl hidden sm:block md:text-2xl text-blue-800 font-bold">EduGrade</h1>
        </div>
        {/* NavLinks */}
        ...
        <div className='flex items-center space-x-4'>
          <Link href="/sign-in" className="box-border relative z-30 inline-flex items-center justify-center w-auto px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-indigo-600 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-indigo-300 ring-offset-indigo-200 hover:ring-offset-indigo-500 ease focus:outline-none">
